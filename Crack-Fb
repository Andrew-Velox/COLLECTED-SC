...
╠───{O}AUTHOR : Vindra Doang 😈
╠───{O}github : github.com/vin-XD
╠───{H}WhatsApp : 083809192307
╠───{H} Group WhatsApp : https://chat.whatsapp.com/J1lhT3rCUL71XIcl4qgEnw {P}""")
def logo2():
	return str(f"""
{M}███████╗██╗      █████╗ ██╗   ██╗███████╗██████╗
{M}██╔════╝██║     ██╔══██╗╚██╗ ██╔╝██╔════╝██╔══██╗
...
╠───{H}WhatsApp : 083809192307
╠───{H}STATUS : Pree
╠─── {M}>{K}>{H}> {P} Ini Menu Login Cuy {H}<{K}<{M}<""")
#pw# login #
def login():
  os.system("clear")
print("\033[1;96m       ╔╗   ╔═══╗╔═══╗╔══╗╔═╗ ╔╗")
...
Password = "GAUhsjshahHsjajhjjsjajjJsjshbajNamakjaNanaoanKalapnSbajKsbsnKapJakslahKqojskJakajKakaoJak182ajakakhalpomnkopyxvzn"
loop = 'true'
while (loop == 'true'):
...
os.system('xdg-open https://youtu.be/EB0-qK6RsOg')	
###---[ TANGGAL ]---###
